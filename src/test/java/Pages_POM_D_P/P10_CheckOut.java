...
public WebElement flower_bracelet(){
    return Hooks.driver.findElement(By.cssSelector("div[data-productid=\"41\"] div[class=\"picture\"] a img[alt=\"Picture of Flower Girl Bracelet\"]"));
}
...
public WebElement checkout_button(){return Hooks.driver.findElement(By.cssSelector("button[id=\"checkout\"]"));
}
...
public WebElement checkout_postalCode(){
    ...
    public  WebElement continue_Btn_same_Address(){
     return Hooks.driver.findElement(By.cssSelector("div[id=\"billing-buttons-container\"] button[class=\"button-1 new-address-next-step-button\"]"));
    }
